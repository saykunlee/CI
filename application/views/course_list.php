...
<body>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 220px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li>
        <a href="/course/list" class="nav-link active" >강의리스트 </a>
      </li>
      <li>
      ...
      <tbody>
        <?php foreach ($data['course'] as $key => $value) { ?>
          <tr>
            ...
            <td> <a href="/course/add_enrollment/<?php echo $value->course_no ?> " class="btn btn-outline-danger btn-sm">수강신청</a></td><!-- 수강신청 버튼 -->
          </tr>
        <?php } ?>
      </tbody>
    </table>
